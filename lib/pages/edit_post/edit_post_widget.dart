...
class _EditPostWidgetState extends State<EditPostWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      setState(() {
        _model.imagePhotoPath = widget.imageURL;
      });
    });
    ...
    return Scaffold(
        ...
        actions: [
          Padding(
            ...
            child: FFButtonWidget(
              onPressed: () async {
                await widget.currentPost!.update(createChatRecordData(
                  postPhoto: _model.imagePhotoPath,
                  postTitle: _model.postTitleController.text,
                  postDescription: _model.postDescriptionController.text,
                  postCategory: _model.choiceChipsValue,
                ));
                context.safePop();
              },
              text: 'Edit',
      ...
      body: SafeArea(
        ...
        child: FutureBuilder<ChatRecord>(
          future: ChatRecord.getDocumentOnce(widget.currentPost!),
              ...
              children: [
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: TextFormField(
                      controller: _model.postTitleController ??=
                          TextEditingController(
                        text: columnChatRecord.postTitle,
                      ),
                      focusNode: _model.postTitleFocusNode,
                      onChanged: (_) => EasyDebounce.debounce(
                        '_model.postTitleController',
                      ...
                      validator: _model.postTitleControllerValidator
                          .asValidator(context),
                    ),
                  ),
                ),
                  ...
                  child: Padding(
                    ...
                    child: TextFormField(
                      controller: _model.postDescriptionController ??=
                          TextEditingController(
                        text: columnChatRecord.postDescription,
                      ),
                      ...
                      maxLines: 7,
                      cursorColor: FlutterFlowTheme.of(context).primary,
                      validator: _model.postDescriptionControllerValidator
                          .asValidator(context),
                    ),
                  ),
                ),
                      ...
                      Padding(
                        ...
                        child: FlutterFlowIconButton(
                          ...
                          onPressed: () async {
                            ...
                            setState(() {
                              _model.imagePhotoPath = _model.uploadedFileUrl;
                            });
                          },
                        ),
                      ),
